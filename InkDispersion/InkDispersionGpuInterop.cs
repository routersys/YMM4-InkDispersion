...
internal sealed class InkDispersionGpuInterop : IDisposable
{
    ...
    private InkDispersionGpuInterop(
    ...
    public static unsafe InkDispersionGpuInterop? TryCreate(IGraphicsDevicesAndContext devices)
    {
        ...
        try
        {
            ...
            return new InkDispersionGpuInterop(device, d3dDevice, d3dContext, fence, renderContext, d3d12Fence);
        }
        catch
        {
